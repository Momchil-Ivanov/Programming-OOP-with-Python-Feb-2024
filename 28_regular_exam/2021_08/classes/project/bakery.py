...
class Bakery:
    ...
    def order_food(self, table_number: int, *food_names: []):
        ...
        for food_name in food_names:
            ...
            if food is None:
                skipped_ordered_foods += f"{food_name}\n"
            else:
                table.order_food(food)
                ordered_foods += f"{str(food)}\n"
    ...
    def order_drink(self, table_number: int, *drink_names: []):
        ...
        for drink_name in drink_names:
            ...
            if drink is None:
                skipped_ordered_drinks += f"{drink_name}\n"
            else:
                table.order_drink(drink)
                ordered_drinks += f"{str(drink)}\n"
    ...
    def find_drink_by_name(self, drink_name: str):
