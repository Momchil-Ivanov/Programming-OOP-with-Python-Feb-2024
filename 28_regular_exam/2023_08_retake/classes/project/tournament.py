...
class Tournament:
    ...
    def play(self, team_name1: str, team_name2: str):
        team1 = next(filter(lambda t: t.name == team_name1, self.teams), None)
        team2 = next(filter(lambda t: t.name == team_name2, self.teams), None)
    ...
    def get_team_points(team: BaseTeam):
        return sum(e.protection for e in team.equipment) + team.advantage
